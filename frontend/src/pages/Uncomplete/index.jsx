...
function Uncomplete() {
  ...
  function afficherTask(task, niveau){
    ...
    return(
      <Task key={key} id_task={task.id_task} title={task.title} description={task.des} end_date={task.end_date} duration={task.duration} task_category={task.task_category} niveau={niveau}/>
    )
  }
